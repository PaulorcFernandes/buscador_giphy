  ...
  Future<Map> _getGifs() async{
    ...
    if(_search == null || _search.isEmpty) {
      response = await http.get(
          Uri.parse("https://api.giphy.com/v1/gifs/trending?api_key=EWVox7JDrR7qf43SPkb3I9wcFKdfP2AU&limit=25&rating=g")
      );
    } else {
      response = await http.get(
        Uri.parse("https://api.giphy.com/v1/gifs/search?api_key=EWVox7JDrR7qf43SPkb3I9wcFKdfP2AU&q=$_search&limit=19&offset=$_offset&rating=g&lang=en")
      );
    }
